---
name: auto-diary
description: "Automatically write daily/weekly/monthly diary summaries (bilingual: Chinese for Jialin, English for HexaLoop) and send Feishu Interactive card notifications. Extracts actionable insights to auto-learn.md (format A) for the HexaLoop meditation layer. Triggered by cron: 'diary write' at 08:20 (yesterday summary), 'diary weekly' on Saturday 09:00 (7-day aggregation), 'diary monthly' on 1st of month 09:00 (30-day aggregation). Also handles edge cases: no memory files, empty farm state, Feishu push failure."
---
